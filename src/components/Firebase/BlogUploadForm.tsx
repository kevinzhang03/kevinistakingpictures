  ...
  return (
    <>
      <div className="w-full lg:w-4/12 flex flex-col gap-y-4">
        ...
        <label htmlFor="include cover photo?" className="text-xs text-antique-700/50">
          include cover photo?
          <div id="include cover photo?" className="flex justify-evenly items-center h-10 gap-x-2 text-antique-900">
            <label htmlFor="no cover photo" className="flex items-center mx-2 gap-x-2 text-sm">
              <input
                defaultChecked
                id="no cover photo"
                type="radio"
                name="includeCoverPhoto"
                value={false.toString()}
                onChange={() => setIncludeCoverPhoto(false)}
                className="w-4 h-4"
              />
              no
            </label>
            <label htmlFor="yes cover photo" className="flex items-center mx-2 gap-x-2 text-sm">
              <input
                id="yes cover photo"
                type="radio"
                name="includeCoverPhoto"
                value={true.toString()}
                onChange={() => setIncludeCoverPhoto(true)}
                className="w-4 h-4"
              />
              yes
            </label>
